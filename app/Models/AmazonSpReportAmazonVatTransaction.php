...
class AmazonSpReportAmazonVatTransaction extends Model
{
    ...
    public static function saveData(array $data)
    {
        $mappedData = [
            ...
            'promo_gift_wrap_amt_vat_excl' => (float) ($data['promo_gift_wrap_amt_vat_excl'] ?? 0),
            'promo_gift_wrap_amt_vat_incl' => (float) ($data['promo_gift_wrap_amt_vat_incl'] ?? 0),
            'promo_gift_wrap_vat_amt' => (float) ($data['promo_gift_wrap_vat_amt'] ?? 0),
            'promo_price_of_items_amt_vat_excl' => (float) ($data['promo_price_of_items_amt_vat_excl'] ?? 0),
            'promo_price_of_items_amt_vat_incl' => (float) ($data['promo_price_of_items_amt_vat_incl'] ?? 0),
            'promo_price_of_items_vat_amt' => (float) ($data['promo_price_of_items_vat_amt'] ?? 0),
            'promo_ship_charge_amt_vat_excl' => (float) ($data['promo_ship_charge_amt_vat_excl'] ?? 0),
            'promo_ship_charge_amt_vat_incl' => (float) ($data['promo_ship_charge_amt_vat_incl'] ?? 0),
            'promo_ship_charge_vat_amt' => (float) ($data['promo_ship_charge_vat_amt'] ?? 0),
            'qty' => (int) ($data['qty'] ?? 0),
            ...
            'seller_arrival_country_vat_number' => $data['seller_arrival_country_vat_number'] ?? null,
            'seller_arrival_vat_number_country' => $data['seller_arrival_vat_number_country'] ?? null,
            'seller_depart_country_vat_number' => $data['seller_depart_country_vat_number'] ?? null,
            'seller_depart_vat_number_country' => $data['seller_depart_vat_number_country'] ?? null,
            ...
            'statistical_code_arrival' => $data['statistical_code_arrival'] ?? null,
            'statistical_code_depart' => $data['statistical_code_depart'] ?? null,
            ...
            'tax_collection_responsibility' => $data['tax_collection_responsibility'] ?? null,
            'tax_reporting_scheme' => $data['tax_reporting_scheme'] ?? null,
            'taxable_jurisdiction' => $data['taxable_jurisdiction'] ?? null,
            'taxable_jurisdiction_level' => $data['taxable_jurisdiction_level'] ?? null,
            'total_activity_supplementary_unit' => (int) ($data['total_activity_supplementary_unit'] ?? 0),
            'total_activity_value_amt_vat_excl' => (float) ($data['total_activity_value_amt_vat_excl'] ?? 0),
            'total_activity_value_amt_vat_incl' => (float) ($data['total_activity_value_amt_vat_incl'] ?? 0),
            'total_activity_value_vat_amt' => (float) ($data['total_activity_value_vat_amt'] ?? 0),
            'total_activity_weight' => (float) ($data['total_activity_weight'] ?? 0),
            'total_gift_wrap_amt_vat_excl' => (float) ($data['total_gift_wrap_amt_vat_excl'] ?? 0),
            'total_gift_wrap_amt_vat_incl' => (float) ($data['total_gift_wrap_amt_vat_incl'] ?? 0),
            'total_gift_wrap_vat_amt' => (float) ($data['total_gift_wrap_vat_amt'] ?? 0),
            'total_price_of_items_amt_vat_excl' => (float) ($data['total_price_of_items_amt_vat_excl'] ?? 0),
            'total_price_of_items_amt_vat_incl' => (float) ($data['total_price_of_items_amt_vat_incl'] ?? 0),
            'total_price_of_items_vat_amt' => (float) ($data['total_price_of_items_vat_amt'] ?? 0),
            'total_ship_charge_amt_vat_excl' => (float) ($data['total_ship_charge_amt_vat_excl'] ?? 0),
            'total_ship_charge_amt_vat_incl' => (float) ($data['total_ship_charge_amt_vat_incl'] ?? 0),
            'total_ship_charge_vat_amt' => (float) ($data['total_ship_charge_vat_amt'] ?? 0),
        ...
        self::updateOrCreate(
            [
                ...
                'vat_inv_number' => $mappedData['vat_inv_number'],
